...
$client = new \Contentful\Delivery\Client($_ENV['access_token'], $_ENV['space_id']);
$query = new \Contentful\Delivery\Query();
$query->setContentType('posts')->setInclude(1);
...
foreach ($posts as $post) {
    ...
    // Get Image
    $image = $post->getImage();
    echo $image->getTitle().PHP_EOL;
    echo json_encode($image->getFile()->jsonSerialize()).PHP_EOL;
}
...
<div class="h-screen bg-white flex items-center justify-center font-sans text-gray-700" style="font-family: 'Jost', sans-serif">
    <div class="font-medium items-center text-center flex flex-col justify-center h-full">
        <div class="flex flex-col justify-center items-center">
            ...
            <pre><?php echo json_encode($posts) ?></pre>
